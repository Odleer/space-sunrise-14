...
public sealed partial class FactoryComponent : Component
{
    ...
    /// <summary>
    /// a whitelist for what entities can be inserted into this factory
    /// </summary>
    [DataField]
    public EntityWhitelist? Whitelist;

    /// <summary>
    /// a blacklist for what entities cannot be inserted into this factory
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// whether or not we cut off the sound early when the processing ends.
    /// </summary>
    [DataField]
